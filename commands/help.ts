...
export default {
    ...
    if(message.channel.id === "992517006345637890" && !message.member?.permissions.has("MUTE_MEMBERS"))
    {
       ...
       return "You can't use bot commands here!";
        ...
        {
          const HelpFunEmbed = new MessageEmbed()
        ...
        {
          const HelpMiscEmbed = new MessageEmbed()
          .setTitle("📚Misc Commands")
          .addField(prefix + "credits", "See who made the bot. Usage: ``" + prefix + "credits``")
          .addField(prefix + "membercount", "See how many members there are. Usage: ``" + prefix + "membercount``")
